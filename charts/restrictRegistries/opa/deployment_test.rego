...
test_unallowed_container_Deployment {
...
test_unallowed_initContainer_Deployment {
    registries := ["eu.gcr.io/test"]
    results := violation with input.review.object as deploymentInit with input.parameters.approvedRegistries as registries
